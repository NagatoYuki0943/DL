...
if __name__ == "__main__":
    ...
    pre_weights = torch.load(r"D:\AI\预训练权重\efficientnetv2-s.pth")

    # model = efficientnet_v2_s(num_classes=10)
    # # 不要最后的分类层head
    # pre_dict ={k: v for k, v in pre_weights.items() if "head" not in k}
    ...
    x = torch.rand(2, 3, 384, 384).to(device)
