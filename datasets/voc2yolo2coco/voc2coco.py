...
# train/val存放路径
txt_list = ["VOCdevkit/VOC2007/ImageSets/Main/train.txt", "VOCdevkit/VOC2007/ImageSets/Main/val.txt"]
# train/val存放路径
...
def main():
    for txt, json_name in zip(txt_list, json_name_list):
        ...
        with open(json_path, "w", encoding="utf-8") as f:
            json.dump(ann_js, f, indent=4, ensure_ascii=False)  # indent=4 更加美观显示 ensure_ascii=False 防止中文乱码
